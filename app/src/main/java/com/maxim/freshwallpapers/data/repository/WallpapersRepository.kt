package com.maxim.freshwallpapers.data.repository

import android.content.Context
import com.maxim.freshwallpapers.BuildConfig
...
import com.maxim.freshwallpapers.di.WallpapersRepositoryEntryPoint
        ...
        try {
            val deferred = CoroutineScope(Dispatchers.IO).async {
                wallpapersApi.getImageList(
                    com.maxim.freshwallpapers.BuildConfig.API_KEY,
                    IMAGE_PER_PAGE,
                    PHOTO,
                    SAFE_SEARCH,
                    collection
